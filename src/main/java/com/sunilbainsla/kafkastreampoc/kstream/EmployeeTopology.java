...
public class EmployeeTopology implements Function<KStream<String, Employee>, KStream<String, Employee>[]> {
    ...
    public KStream<String, Employee>[] apply(KStream<String, Employee> employeeKStream) {
        ...
        // Materialized.<String, DepartmentAggregate, KeyValueStore<Bytes, byte[]>>as("MyStoreName").withKeySerde(AppSerdes.String()).withValueSerde(AppSerdes.DepartmentAggregate()));
        employeeKStream.peek((k, v) -> System.out.println("Data after process------>" + v));
