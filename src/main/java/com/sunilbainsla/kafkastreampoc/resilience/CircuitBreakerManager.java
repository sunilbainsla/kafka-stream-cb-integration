...
import static io.github.resilience4j.circuitbreaker.CircuitBreaker.StateTransition.HALF_OPEN_TO_OPEN;
import static io.github.resilience4j.circuitbreaker.CircuitBreaker.StateTransition.OPEN_TO_HALF_OPEN;
...
public class CircuitBreakerManager {
  ...
  private void controlStateTransition(
    ...
    Optional
      ...
      .forEach(
        consumer -> {
          ...
          if (
            stateTransition.equals(CLOSED_TO_OPEN) ||
